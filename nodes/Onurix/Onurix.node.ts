...
export class Onurix implements INodeType {
  description: INodeTypeDescription = {
    ...
    description:
      "Interact with Onurix API - SMS, WhatsApp, Calls, URL Shortener",
    defaults: {
      name: "Onurix",
    },
    inputs: ["main"],
    ...
    properties: [
      ...
      // SMS Fields
      {
        ...
        default: "",
        description:
          "Phone number(s) to send SMS to. For multiple numbers, separate with commas.",
      },
      {
        displayName: "Message",
        name: "sms",
      ...
      // Call Fields
      {
        ...
        default: "",
        description:
          "Phone number(s) to call. For multiple numbers, separate with commas.",
      },
      {
        displayName: "Message",
        name: "message",
      ...
      try {
        ...
        if (resource === "sms") {
          if (operation === "send") {
            ...
            const sms = this.getNodeParameter("sms", i) as string;
        ...
        if (resource === "call") {
          if (operation === "send") {
            ...
            const voice = this.getNodeParameter(
              "voice",
              i,
              "Mariana",
            ) as string;
            const audioCode = this.getNodeParameter(
              "audioCode",
              i,
              "",
            ) as string;
        ...
        if (resource === "whatsapp") {
          if (operation === "sendTemplate") {
            const fromPhoneMetaId = this.getNodeParameter(
              "fromPhoneMetaId",
              i,
            ) as string;
            const phone = this.getNodeParameter("phone", i) as string;
            ...
            const messageValue = this.getNodeParameter(
              "messageValue",
              i,
            ) as string;
        ...
        if (resource === "url") {
          if (operation === "shorten") {
            const urlLong = this.getNodeParameter("urlLong", i) as string;
